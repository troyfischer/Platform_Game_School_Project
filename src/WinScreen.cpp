...
WinScreen::WinScreen(SDL_Renderer *renderer)
{
    ...
    _youWon = new Text(renderer, "You escaped!",{0,255,255,255}, "./resources/fonts/Times New Roman.ttf", 30);
    _tryAgain = new Text(renderer, "Press Return to play again", {0,255,255,255}, "./resources/fonts/Times New Roman.ttf", 30);
}

...
LoseScreen::LoseScreen(SDL_Renderer *renderer)
{
    ...
    _youLost = new Text(renderer, "You didn't escape the dungeon", {255,0,0,255}, "./resources/fonts/Times New Roman.ttf", 30);
    _tryAgain = new Text(renderer, "Press Return to try again", {255,0,0,255}, "./resources/fonts/Times New Roman.ttf", 20);
}
